...
<head>
    ...
    <title>{{ config('app.name', 'YAPMS') }}</title>

    <!-- Custom styles -->
    <link href="/css/custom-client.css" rel="stylesheet">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if (Auth::guest())
                        ...
                        {{-- TODO RJFORBE Not sure where this is getting used, odd. 12/05/2016 --}}
                ...
                {{-- TODO RJFORBE 12/06/2016 - Temp commented out,...
