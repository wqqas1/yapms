    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel-body">
                <h3 class="page-header">Add Owner</h3>
                <div class="col-md-2">
                ...
                @endif
                <form class="form-horizontal" role="form" method="POST" action="/admin/owners/store">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="cell" type="text" class="form-control" name="cell" value="{{ old('cell') }}" placeholder="555-555-5555" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="phone" type="text" class="form-control" name="phone" value="{{ old('phone') }}" placeholder="555-555-5555">
                        </div>
                    </div>
