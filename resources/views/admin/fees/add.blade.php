...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10 col-md-offset-2 main">
            <h3 class="page-header">Add Fee</h3>
            <div class="col-md-2">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" method="POST" action="/admin/fees/store">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select class="form-control" name="include-with-rate" required>
